...
export default class APIInterface {
    ...
    static playAdvGetList(userId, numberPerPage, currentPage) {
        ...
        var esc = encodeURIComponent;
        var query = Object.keys(params).map(k => esc(k) + '=' + esc(params[k])).join('&');
        // console.log("playAdvGetList")
        // console.log(ApiConstant.BASE_URL + '/playAdv/getPlayAdvList?' + query);
        // console.log("playAdvGetList")
    ...
    static playAdvGetListFromAdmin(userId, numberPerPage, currentPage) {
        ...
        var esc = encodeURIComponent;
        var query = Object.keys(params).map(k => esc(k) + '=' + esc(params[k])).join('&');
        // console.log("playAdvGetListFromAdmin")
        // console.log(ApiConstant.BASE_URL + '/playAdv/getPlayAdvListFromAdmin?' + query);
        // console.log("playAdvGetListFromAdmin")
    ...
    static envGetDetailsByMac(mac) {
        ...
        var esc = encodeURIComponent;
        var query = Object.keys(params).map(k => esc(k) + '=' + esc(params[k])).join('&');
        // console.log("请求接口=" + ApiConstant.BASE_URL + '/env/getEnvDetailsByMac?' + query)
